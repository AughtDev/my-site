...
export function GithubIcon({size}: CustomIconProps) {
    return (
        <svg id="github-icon" fill="#000" width={size} height={size} viewBox="0 0 1920 1920"
...
export function XIcon({size}: CustomIconProps) {
    return (
        <svg id="x-icon" width={size} height={size} viewBox="0 0 330 330" version="1.1"
             xmlns="http://www.w3.org/2000/svg">
            <path
